...
const mined_blocks = require("./mined_blocks");
...
const blocks = mined_blocks.get_blocks(mySeed);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (go) {
            ...
            const targetAddress = wallet.address.toString({ urlSafe: true, bounceable: true });
            const blocks = mined_blocks.get_blocks(mySeed, targetAddress);
